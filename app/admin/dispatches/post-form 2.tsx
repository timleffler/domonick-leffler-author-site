...
export function PostForm({ post }: { post?: Post }) {
  ...
  return <>
    ...
    <div className="form-section"><h2>Post content</h2><Field label="Article" hint="To start a new paragraph, press Return twice so there is one blank line between paragraphs."><textarea name="content" rows={24} defaultValue={post?.content ?? ""} required /></Field></div>
